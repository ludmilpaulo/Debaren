...
SECRET_KEY = 'django-insecure-h594n^m0#m0e%033#oe!g-=0@0me6p_1r5w9*b6u8s5m*2#fj6'
...
ROOT_URLCONF = 'debaren_backend.urls'
...
WSGI_APPLICATION = 'debaren_backend.wsgi.application'
...
CONTACT_EMAIL = "info@ghanadude.com"
